...
namespace NationBuilder.Migrations
{
    ...
    [Migration("20160921172158_Initial")]
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("NationBuilder.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NationBuilder.Models.Economy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NationBuilder.Models.Geography", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NationBuilder.Models.NationsResources", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NationBuilder.Models.ApplicationUser", b =>
                {
                    b.HasOne("NationBuilder.Models.Nation")
                        .WithOne("User")
                        .HasForeignKey("NationBuilder.Models.ApplicationUser", "NationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
